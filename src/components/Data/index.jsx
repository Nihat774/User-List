...
function Data() {
  ...
  // const [clickedUserSchool, setClickedUserSchool] = useState("");
  // const [clickedUserCourse, setClickedUserCourse] = useState("");
  ...
  return (
    <section className="flex flex-col gap-3 min-h-[65vh]">
      {data
        ...
        .map(({ id, name, school, course }) => {
          return (
            <React.Fragment key={id}>
              <hr className="text-slate-400 mx-7" />
              <div className="flex justify-around py-3">
                <p className="w-[40px]">{id}</p>
                ...
                <div className="flex gap-3 items-center">
                  <p className="w-[140px] text-slate-600 text-center">
                    {course}
                  </p>
                </div>
      ...
      <div
        ...
        } bg-neutral-300 rounded-lg w-[40vw] h-fit p-5 absolute top-[12%] right-[32%]`}
      >
        {/* close icon */}
...

        {
          ...
          >
            ...
            <input
              type="text"
              required
              className="p-3 rounded-lg bg-white w-[30vw]"
            ...
            <div className="flex justify-center">
              <button className="p-2 w-[15vw] bg-blue-500 text-white rounded-lg cursor-pointer">
                Change
              </button>
            </div>
          </form>
